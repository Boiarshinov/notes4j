...
Хранение данных в Cassandra основано на структуре данных [LSM-tree](../data_structures/lsm_tree.md).
Основные понятия:
- memtable - упорядоченное хранение в оперативной памяти недавно вставленных данных
- sstable - упорядоченное хранение на диске давно вставленных данных
- commit log - неупорядоченное хранение на диске недавних записей. Используется для восстановления при сбоях
- tombstone - пометка об удалении записи

Подробнее о LSM-tree читай в [отдельной заметке](../data_structures/lsm_tree.md).
