...
### Version Catalog
Version catalog - это файл `libs.version.toml`, находящийся, как правило, в директории `/gradle` проекта, в котором описаны версии зависимостей и плагинов.
...
На зависимости, объявленные в `libs.version.toml`, затем можно ссылаться в `build.gradle` файлах по ключу с использованием префикса `libs`.
```kotlin
dependencies {
