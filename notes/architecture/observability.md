...
Observability - это свойство системы, позволяющее увидеть в каком состоянии она находится и обработкой чего она занимается.

- Logs - логи фиксируют события, произошедшие в конкретный момент времени
- Trasing - трассировка позволяет связать события, произошедшие в рамках обработки некого запроса
