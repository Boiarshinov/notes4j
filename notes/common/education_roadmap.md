...
- [ ] Цикл статей от Java чемпиона: https://cguntur.me/2020/05/20/understanding-apache-maven-the-series/
...
- [ ] Масштабирование БД
- [ ] Репликация
- [ ] Шардинг / партицирование
- [ ] Индексы
- [X] Общая информация
- [ ] Нетрадиционные индексы в postgreSQL
- [ ] https://dataschool.com/books/
- [ ] курс от Ильи Зеленова

- [ ] Безопасность веб-приложений
- [ ] Курс на Stepik
- [ ] Конференция: https://habr.com/ru/company/avito/blog/508730/

- [ ] Архитектура ПО
- [X] Роберт Мартин "Чистая архитектура"
- [ ] Книга с кабанчиком
- [ ] Видео по архитектуре веб-приложений: https://www.youtube.com/watch?v=9mZmc6a0tmM
- [ ] Видео с ссылками на полезности по проектированию систем: https://www.youtube.com/watch?v=4iMMQUBmVA4
- [ ] Пособие по проектированию систем: https://github.com/voitau/system-design-primer/blob/master/README-ru.md
- [ ] Книга: Крис Ричардсон "Микросервисы"

- [X] Шаблоны проектирования
- [X] Прочитать книгу HeadFirst
- [X] Написать заметочки

- [ ] GC
- [ ] Серия статей про GC от 2015 года: https://habr.com/ru/post/269621/