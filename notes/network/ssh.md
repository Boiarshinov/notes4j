...
После этого клиент и сервер с помощью алгоритма Диффи-Хэлмана создают симметричный ключ шифрования, который будет использоваться для данной сессии обмена данными.
