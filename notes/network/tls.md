...
## Версии
- __TLS 1.0__ (1999). Создан на основе SSL 3.0.
- __TLS 1.1__ (2006).
- __TLS 1.2__ (2008). Добавилось множество современных алгоритмов шифрования.
- __TLS 1.3__ (2018). Ускорен handshake с 2-RTT до 1-RTT. Отключена возможность использования алгоритмов [сжатия](../algorithms/compression.md) на транспортном уровне, т.к. они давали возможность частично восстановить зашифрованные данные.

На 2026 год TLS 1.0 и 1.1 окончательно устарели и их не рекомендуется использовать.
